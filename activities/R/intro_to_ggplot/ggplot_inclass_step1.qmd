...
```{r scatter-depth, fig.cap="Scatterplot with depth", fig.height=6, fig.width=8, out.width="95%"}
ggplot(data = df.diamonds,
       mapping = aes(x = depth,
                     y = table)) +
  geom_point()
...
```{r scatter-depth-transparent, fig.cap="Scatterplot with depth and transparency", fig.height=6, fig.width=8, out.width="95%"}
ggplot(data = df.diamonds,
       mapping = aes(x = depth,
                     y = table)) +
...
```{r bar-price-clarity, fig.cap='Bar plot for price against clarity.', out.width="90%", fig.align="center",}
ggplot(data = df.diamonds,
       mapping = aes(x = clarity,
                     y = price)) +
  stat_summary(fun = "mean", 
...
```{r bar-price-clarity-color, fig.cap='Bar plot for price against clarity, with color', out.width="90%", fig.align="center",}
ggplot(data = df.diamonds,
       mapping = aes(x = clarity,
                     y = price)) +
  stat_summary(fun = "mean", 
...
```{r line-plot-price-color, out.width="90%", fig.align="center", fig.cap="Line graph of price against color."}
ggplot(data = df.diamonds,
       mapping = aes(x = color,
                     y = price,
                    group = clarity,
...
```{r line-plot-price-color-range, out.width="90%", fig.align="center", fig.cap="Practice plot 3."}
ggplot(data = df.diamonds,
       mapping = aes(x = color,
                     y = price,
                    group = clarity,
  ...
  stat_summary(fun.data = "mean_cl_boot", 
               ...
               fill = "white",
               position = position_dodge2(width = 0.8)) + 
  geom_vline(aes(xintercept = color),  
             linetype = "dashed", 
             position = "dodge")
